...
namespace Ibralogue
{
    public class TypewriterDialogueManager : SimpleDialogueEngine
    {
        /// <summary>
        ...
        //        if (foundChoice.Key != null && _lineIndex == foundChoice.Value) dialogueView.DisplayChoices(_currentConversation);
        //    }
